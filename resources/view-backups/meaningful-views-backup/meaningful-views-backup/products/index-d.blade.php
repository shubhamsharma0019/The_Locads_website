         ...
         <section class="signage10-products w-full max-w-[1387px] mx-auto px-[101.5px] pt-[64px] pb-[64px] max-[1387px]:px-[24px] max-md:px-[16px]">
            ...
            <div class="signage10-products-grid w-[1184px] max-w-full mx-auto grid grid-cols-3 gap-[24px] max-[1387px]:grid-cols-2 max-md:grid-cols-1">
                ...
                <div class="signage10-card w-[373.33px] h-[569px] max-[1387px]:w-full max-md:h-auto bg-white rounded-[16px] border border-[#E5E7EB]">
                    ...
                    <!-- IMAGE -->
                    <div class="signage10-card-image w-[371.33px] h-[224px] max-[1387px]:w-full max-md:h-auto bg-[#F3F4F6] rounded-t-[16px]"><img class="rounded-[14px] max-md:block max-md:w-full max-md:h-auto max-md:object-cover"
                    ...
                    <div class="signage10-card-content w-full h-[343px] max-md:h-auto px-[24px] pt-[24px]">
                        ...
                        <!-- BOTTOM SECTION -->
                        <div
                            class="signage10-card-bottom w-[323.33px] max-[1387px]:w-full mt-[24px] pt-[17px] border-t border-[#E5E7EB] flex flex-col gap-[16px] max-md:h-auto max-md:pb-2">
                            ...
                            <div class="w-full h-[42px] flex items-center gap-[8px]">
                                ...
                                <!-- BUTTON -->
                                <div
                                    class="signage10-card-action-primary w-[261.33px] h-[42px] max-[1387px]:w-[calc(100%-62px)] bg-[#155DFC] rounded-[14px] flex items-center justify-center">
