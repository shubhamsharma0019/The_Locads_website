...
<body class="m-0 overflow-x-hidden bg-white">
    ...
    <div class="signage10-shell w-full max-w-[1387px] mx-auto">
                    ...
                    <div class="signage10-card-content w-full h-[343px] max-md:h-auto px-[24px] pt-[24px]">
                        ...
                        <div class="signage10-card-bottom w-[323.33px] max-[1387px]:w-full mt-[24px] pt-[17px] border-t border-[#E5E7EB] flex flex-col gap-[16px] max-md:h-auto max-md:pb-2">
                            ...
                            <div class="w-full h-[42px] flex items-center gap-[8px]">
                                <a href="{{ route('products.detail', $product['slug']) }}" class="signage10-card-action-primary w-[261.33px] h-[42px] max-[1387px]:w-[calc(100%-62px)] bg-[#155DFC] rounded-[14px] flex items-center justify-center">
        ...
        <div class="w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] min-h-[410px] mt-[92px] bg-[#F9FAFB] border-t border-[#E5E7EB] flex justify-center">
            <div class="w-full max-w-[1280px] px-4 sm:px-6 lg:px-[48px] py-10 sm:py-14 lg:py-[81px] flex flex-col">
                ...
                <div class="w-full lg:w-[1184px] min-h-[49px] border-t border-[#E5E7EB] flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pt-[24px] sm:pt-[32px] mt-[24px]">
