...
<head>
    ...
    @include('partials.seo-meta', [
        ...
        'keywords' => 'software licenses, cloud CMS license, offline signage software, The Locads'
    ])
        ...
        <section class="w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] mt-10 sm:mt-[80px] min-h-[394px] bg-gradient-to-b from-[#F9FAFB] to-[#EFF6FF] px-4 sm:px-6 lg:px-[53.5px] py-12 md:py-16 lg:pt-[80px]">
            ...
            <div class="w-full max-w-[1280px] mx-auto text-center">
                ...
                <div class="w-full max-w-[320.88px] mx-auto mt-[32px]">
                    ...
                    <a href="{{ route('contact.alt') }}" class="w-full min-h-[50px] rounded-full border border-[#FFA2A2] bg-[#FFE2E2] px-4 py-3
        ...
        <section class="w-full mx-auto px-4 sm:px-6 md:px-6 lg:px-[101.5px] pt-10 lg:pt-[64px] pb-10 lg:pb-[64px]">
            ...
            <div class="w-full max-w-[1184px] mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 lg:gap-[24px]">
                <div
                    ...
                    onclick="window.location='{{ route('products.detail', ['productSlug' => 'cloud-cms-license-annual-rent', 'return_to' => request()->fullUrl()]) }}'"
                    role="link"
                    tabindex="0"
                    onkeydown="if(event.key==='Enter' || event.key===' '){ event.preventDefault(); window.location='{{ route('products.detail', ['productSlug' => 'cloud-cms-license-annual-rent', 'return_to' => request()->fullUrl()]) }}'; }">
                    ...
                    <div class="w-full h-auto px-[24px] pt-[24px] pb-4 md:pb-6">
                        ...
                        <div
                            ...
                            <div class="w-full flex flex-col sm:flex-row items-stretch sm:items-center gap-[8px]">
                                ...
                                <!-- BUTTON -->
                                <a
                                    href="{{ route('products.detail', ['productSlug' => 'cloud-cms-license-annual-rent', 'return_to' => request()->fullUrl()]) }}"
                ...
                <div
                    class="w-full max-w-[373.33px] h-auto bg-white rounded-[16px] border border-[#E5E7EB] mx-auto cursor-pointer transition hover:shadow-[0_12px_32px_rgba(15,23,42,0.12)]"
                    onclick="window.location='{{ route('products.detail', ['productSlug' => 'pen-drive-software-licence', 'return_to' => request()->fullUrl()]) }}'"
                    role="link"
                    tabindex="0"
                    onkeydown="if(event.key==='Enter' || event.key===' '){ event.preventDefault(); window.location='{{ route('products.detail', ['productSlug' => 'pen-drive-software-licence', 'return_to' => request()->fullUrl()]) }}'; }">
                    ...
                    <div class="w-full h-auto px-[24px] pt-[24px] pb-4 md:pb-6">
                        ...
                        <div
                            ...
                            <div class="w-full flex flex-col sm:flex-row items-stretch sm:items-center gap-[8px]">
                                ...
                                <!-- BUTTON -->
                                <a
                                    href="{{ route('products.detail', ['productSlug' => 'pen-drive-software-licence', 'return_to' => request()->fullUrl()]) }}"
                                    class="w-full sm:w-[261.33px] h-[42px] bg-[#155DFC] rounded-[14px] flex items-center justify-center">
                                    <span class="text-white text-[14px] font-medium">
                                        View Details
                                    </span>
