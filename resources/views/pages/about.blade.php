...
<body class="bg-white flex justify-center overflow-x-hidden">
    ...
    <div class="page-sections w-full max-w-[1387px]">
        ...
        <!-- ================= HERO SECTION ================= -->
        <section class="w-full min-h-[667.33px] px-4 pb-12 pt-16 sm:px-6 sm:pt-24 lg:px-[53.5px] lg:pb-16 lg:pt-[128px]">
            ...
            <div class="w-full max-w-[1280px] min-h-[411.33px] mx-auto flex flex-col lg:flex-row justify-between items-center gap-10 lg:gap-12">
                ...
                <div class="w-full max-w-[616px] min-h-[273.5px] flex flex-col gap-[24px] lg:mt-[68.91px]">
                    ...
                    <div class="w-full max-w-[503px] min-h-[144px]">
                        <h1 class="font-[Inter] font-medium text-[40px] leading-[48px] sm:text-[50px] sm:leading-[60px] lg:text-[60px] lg:leading-[72px] tracking-[-1.5px] text-black">
                            Redefining Visual
                    ...
                    <div class="w-full max-w-[616px] min-h-[98px]">
                        <p class="font-normal text-[20px] leading-[32.5px] text-[#4A5565]">
        ...
        <!-- ================= STATS SECTION ================= -->
        <section class="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen min-h-[366px] bg-[#F9FAFB] px-4 pb-12 pt-14 sm:px-6 sm:pt-16 lg:px-[101.5px] lg:pb-16 lg:pt-[80px]">

            <!-- INNER CONTAINER -->
            <div class="w-full max-w-[1184px] min-h-[206px] mx-auto grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-[24px]">

                <!-- CARD 1 -->
                <div class="flex h-[206px] w-full max-w-[272px] flex-col items-center justify-center gap-4 rounded-[16px] border border-[#E5E7EB] bg-white px-6 text-center">

                    <!-- ICON -->
                    <div class="flex h-[48px] w-[48px] items-center justify-center rounded-full bg-[#DBEAFE]">
                        <img src="{{ asset('icons/40plusicon.svg') }}">
                    </div>

                    <!-- NUMBER -->
                    <div class="h-[40px] w-full">
                        <h2 class="text-[36px] leading-[40px] font-medium text-[#101828]">40+</h2>
                    </div>
                ...
                <div class="flex h-[206px] w-full max-w-[272px] flex-col items-center justify-center gap-4 rounded-[16px] border border-[#E5E7EB] bg-white px-6 text-center">
                    ...
                    <div class="h-[40px] w-full">
                        <h2 class="text-[36px] leading-[40px] font-medium text-[#101828]">10k+</h2>
                    </div>
                ...
                <div class="flex h-[206px] w-full max-w-[272px] flex-col items-center justify-center gap-4 rounded-[16px] border border-[#E5E7EB] bg-white px-6 text-center">
                    ...
                    <div class="h-[40px] w-full">
                        <h2 class="text-[36px] leading-[40px] font-medium text-[#101828]">50k+</h2>
                    </div>
                ...
                <div class="flex h-[206px] w-full max-w-[272px] flex-col items-center justify-center gap-4 rounded-[16px] border border-[#E5E7EB] bg-white px-6 text-center">
                    ...
                    <div class="h-[40px] w-full">
                        <h2 class="text-[36px] leading-[40px] font-medium text-[#101828]">99.9%</h2>
                    </div>
        ...
        <!-- ================= MISSION / VISION ================= -->
        <section class="mx-auto mt-[24px] flex w-full max-w-[1280px] flex-col gap-14 px-4 pb-12 pt-8 sm:px-6 sm:pt-10 lg:gap-[96px] lg:px-[48px] lg:pb-16 lg:pt-0">
            ...
            <div class="w-full max-w-[1184px] min-h-[402px] flex flex-col lg:flex-row justify-between items-center lg:items-start gap-10 lg:gap-12">
                ...
                <div class="w-full max-w-[568px] min-h-[151.75px] flex flex-col items-center lg:items-start gap-[24px] lg:mt-[125.13px]">
                    ...
                    <div class="w-full max-w-[212px] min-h-[40px] text-center lg:text-left">
                        <h2 class="text-[36px] leading-[40px] font-medium text-[#101828]">
                            Our Mission
                        </h2>
                    </div>
            ...
            <div class="w-full max-w-[1184px] min-h-[402px] flex flex-col lg:flex-row justify-between items-center lg:items-start gap-10 lg:gap-12">
                ...
                <div
                    ...
                    <img src="{{ asset('icons/about2img.svg') }}" class="w-full h-full object-cover" />
                </div>
