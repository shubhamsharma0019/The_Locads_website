...
<head>
    ...
    @include('partials.seo-meta', [
        'title' => 'The Locads | Smart Digital Signage Solutions',
        'description' => 'Explore The Locads smart digital signage solutions, commercial displays, cloud software, and industry-ready communication systems.',
        'keywords' => 'The Locads home, digital signage company, smart digital signage, display solutions, commercial signage'
    ])
</head>
        ...
        <section class="home-hero-section w-full min-h-[auto] lg:min-h-[821.7px] bg-white flex flex-col lg:flex-row relative">
            ...
            flex items-center gap-[8px] pl-[16px]">
               ...
               bg-gradient-to-r from-[#E7000B] to-[#155DFC] bg-clip-text text-transparent">
                   ...
                   shadow-[0_4px_6px_-4px_rgba(0,0,0,0.1),0_10px_15px_-3px_rgba(0,0,0,0.1)] flex items-center justify-center">
                                Book a Demo →
                            </a>

                            <!-- Secondary Button -->
                            <a href="{{ route('services') }}" class="w-[198.74px] h-[58px] rounded-full border border-[#D1D5DC] 
                   px-[32px] py-[16px] text-sm font-medium text-black bg-white flex items-center justify-center">
                                Explore Solutions
                            </a>
            ...
            <a
                ...
                class="flex self-center mt-[16px] mb-[8px] h-[34px] w-[20px] rounded-full border-[2px] border-[#99A1AF] items-start justify-center px-[6px] pt-[7px] transition hover:border-[#155DFC] hover:bg-[#EFF6FF] lg:absolute lg:left-[681.5px] lg:top-[751.65px] lg:mt-0">
                ...
                <div class="w-full max-w-[1184px] min-h-[438px] grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-[24px] mt-[48px] lg:mt-[64px]">
                    ...
                    <div class="w-full max-w-[378.66px] h-[438px] mx-auto bg-white rounded-[16px] border border-[#E5E7EB] overflow-hidden">
                        ...
                        <div class="w-full h-[246px] pt-[32px] px-[32px] pb-[24px] flex flex-col">
                            ...
                            <!-- LEARN MORE -->
                            <a href="{{ route('industries') }}" class="mt-auto flex items-center gap-[6px]">
            ...
            <div class="w-full max-w-[1387px] pt-16 lg:pt-[97px] px-4 sm:px-6 lg:px-[101.5px] mx-auto flex justify-center">
                ...
                <div class="w-full max-w-[1184px] min-h-[672.25px] flex flex-col lg:flex-row justify-between items-center lg:items-start gap-10 lg:gap-16">
                    ...
                    bg-[#155DFC1A] flex items-center justify-center">
                        ...
                        <!-- BUTTON -->
                        <div class="mt-[32px]">
                            <a href="{{ route('services') }}" class="w-[178.34px] h-[50px] rounded-full border border-[#E5E7EB] 
                         flex items-center justify-center">
                                <span class="text-[16px] leading-[24px] font-medium text-[#101828]">
                                    Explore Services
                                </span>
            ...
            <div class="home-case-study-card w-full max-w-[1200px] min-h-[573.25px] mx-auto relative rounded-[24px] overflow-hidden">
                ...
                <div class="home-case-study-content absolute top-0 left-0 w-full max-w-[672px] h-full">
                    ...
                    <div class="absolute top-[430px] sm:top-[455px] lg:top-[469.25px] left-[24px] sm:left-[40px] lg:left-[80px]">
                        <a href="{{ route('blog.show', 'airport-wayfinding-case-study') }}" class="text-[16px] font-bold text-white flex items-center gap-[8px]">
                            Read Full Story →
                        </a>
                    </div>
  ...
  <div class="w-full max-w-[1280px] min-h-[248px] mx-auto px-4 sm:px-6 lg:px-[53.5px]">
    ...
    <div class="w-full max-w-[1184px] min-h-[248px] mx-auto">
      ...
      <div class="w-full max-w-[1184px] min-h-[68px] mt-[40px] lg:mt-[60px] flex justify-center">
        ...
        <!-- BUTTON -->
        <a href="{{ route('contact') }}" class="w-[285.46px] h-[68px] bg-[#155DFC] rounded-full flex items-center justify-center shadow-[0_0_30px_rgba(37,99,235,0.5)]">
